...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='sandy.conf'
CONFIGFOLDER='/root/.sandy'
COIN_DAEMON='sandyd'
COIN_CLI='sandy-cli'
COIN_PATH='/usr/local/bin/'
COIN_REPO='https://github.com/sandycoin/sandy.git'
COIN_TGZ='https://github.com/sandycoin/sandy/releases/download/v1.1/Sandy-linux.tgz'
