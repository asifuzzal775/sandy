...
RESOURCES += src/qt/sandy.qrc src/qt/sandy_locale.qrc

TRANSLATIONS += src/qt/locale/sandy_bg.ts \
                src/qt/locale/sandy_de.ts \
                src/qt/locale/sandy_en.ts \
                src/qt/locale/sandy_es.ts \
                src/qt/locale/sandy_fi.ts \
                src/qt/locale/sandy_fr.ts \
                src/qt/locale/sandy_it.ts \
                src/qt/locale/sandy_ja.ts \
                src/qt/locale/sandy_pl.ts \
                src/qt/locale/sandy_pt.ts \
                src/qt/locale/sandy_ru.ts \
                src/qt/locale/sandy_sk.ts \
                src/qt/locale/sandy_sv.ts \
                src/qt/locale/sandy_vi.ts \
                src/qt/locale/sandy_zh_CN.ts \
                src/qt/locale/sandy_zh_TW.ts
