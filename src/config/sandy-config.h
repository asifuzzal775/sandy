/* src/config/sandy-config.h.  Generated from sandy-config.h.in by configure.  */
/* src/config/sandy-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "https://sandy.org"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Sandy Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Sandy Core 2.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "sandy"
