...
#if defined(NDEBUG)
#error "Sandy cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Sandy Signed Message:\n";
...
int64_t GetBlockValue(int nHeight)
{
	...
	if( nHeight > 1 && nHeight <= 7000 ) {
	        nSubsidy = 1 * COIN;
	}else if( nHeight > 7000 && nHeight <= 36000 ) {
	        nSubsidy = 16 * COIN;
	}else if( nHeight > 36000 && nHeight <= 72000 ) {
	        nSubsidy = 18 * COIN;
	}else if( nHeight > 72000 && nHeight <= 112000 ) {
	        nSubsidy = 22 * COIN;
	} else {
		nSubsidy = 12 * COIN;
	}
