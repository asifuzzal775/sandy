...
static Checkpoints::MapCheckpoints mapCheckpoints =
    boost::assign::map_list_of(0, uint256("0x000003aa852876d20502edcb0629810c098fe11f2c13ba379ca251bf0c531f15"));
;
static const Checkpoints::CCheckpointData data = {
    &mapCheckpoints,
    1538140277, // * UNIX timestamp of last checkpoint block
...
public:
	...
	nMasternodeColleteralLimxDev = 2000; //Params().MasternodeColleteralLimxDev()
        ...
        nMaxMoneyOut = 480000000 * COIN;

        const char* pszTimestamp = "Sandy is alive";
        ...
        genesis.nVersion = 1;
        genesis.nTime = 1538140277;
        genesis.nBits = 0x1e0ffff0;
        genesis.nNonce = 20722049;
		
        hashGenesisBlock = genesis.GetHash();
	//printf("%s\n", hashGenesisBlock.ToString().c_str());
	//printf("%s\n", genesis.hashMerkleRoot.ToString().c_str());
        assert(hashGenesisBlock == uint256("0x000003aa852876d20502edcb0629810c098fe11f2c13ba379ca251bf0c531f15"));
        assert(genesis.hashMerkleRoot == uint256("0xba93d2f022f02a9f8e18fe75006a2542a6faf35f7913d8a7c4993221130b5d2f"));
        

        vSeeds.push_back(CDNSSeedData("seed1.sandycoin.io", "seed1.sandycoin.io"));
        vSeeds.push_back(CDNSSeedData("seed2.sandycoin.io", "seed2.sandycoin.io"));
        vSeeds.push_back(CDNSSeedData("seed3.sandycoin.io", "seed3.sandycoin.io"));
        //vFixedSeeds.clear();
        //vSeeds.clear();
        ...
        nStartMasternodePayments = 1538140277; 
    }
...
public:
    CTestNetParams()
    {
        ...
        genesis.nTime = 1538140278;
        genesis.nNonce = 21982841;


        hashGenesisBlock = genesis.GetHash();
        assert(hashGenesisBlock == uint256("0x00000cb7c03e8ce4ff0c496948a055617bb681bcd07466c6fa5a1613935c7b03"));
        ...
        base58Prefixes[SECRET_KEY] = std::vector<unsigned char>(1, 193);
        // Testnet Sandy BIP32 pubkeys start with 'DRKV'
        base58Prefixes[EXT_PUBLIC_KEY] = boost::assign::list_of(0x3a)(0x80)(0x61)(0xa0).convert_to_container<std::vector<unsigned char> >();
        // Testnet Sandy BIP32 prvkeys start with 'DRKP'
        base58Prefixes[EXT_SECRET_KEY] = boost::assign::list_of(0x3a)(0x80)(0x58)(0x37).convert_to_container<std::vector<unsigned char> >();
        // Testnet Sandy BIP44 coin type is '1' (All coin's testnet default)
        ...
        nStartMasternodePayments = 1538140278;
    }
    const Checkpoints::CCheckpointData& Checkpoints() const
    {
        return dataTestnet;
...
public:
    CRegTestParams()
    {
        ...
        genesis.nTime = 1538140279;
        genesis.nBits = 0x207fffff;
        genesis.nNonce = 4;
		
        hashGenesisBlock = genesis.GetHash();
        nDefaultPort = 57123;
        assert(hashGenesisBlock == uint256("0x0ae56d258a4fc940d0a81cc2714dfe5819645482419f4df98d54fbb86e70aa74"));
