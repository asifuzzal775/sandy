...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* SDY features */
        {"sandy", "masternode", &masternode, true, true, false},
        {"sandy", "masternodelist", &masternodelist, true, true, false},
        {"sandy", "mnbudget", &mnbudget, true, true, false},
        {"sandy", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"sandy", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"sandy", "mnsync", &mnsync, true, true, false},
        {"sandy", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"sandy", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use sandyd, or the -server option to sandy-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
                                               ...
                                               "for example: alertnotify=echo %%s | mail -s \"Sandy Alert\" admin@foo.com\n"),
...
{
    return "> sandy-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:33622/\n";
}
